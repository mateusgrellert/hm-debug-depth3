...
#define DEBUG_PRE_SMP 0  // debug right after 2Nx2N calc
...
/*const std::string featureMap[] = {"POC","X","Y","W","D","dQP","PRED_MODE","PU_SIZE","BITS","DISTORTION",\
  ...
  */
const std::string featureMap[] = {"POC","X","Y","W","D","dQP","PRED_MODE","PU_SIZE","BITS","DISTORTION","BEST_COST","BEST_BINS","SIDE_INFO",\
                                "SAD","SSE","MSE","COST_2Nx2N","COST_MSM", "COST_2NxN", "COST_Nx2N","RATIO_2Nx2N-MSM",\
                                "REL_RATIO_2Nx2N-MSM","RATIO_BEST_2Nx2N","RATIO_BEST-MSM", "REL_RATIO_BEST-MSM",\
                                "TU_DEPTH","CBF","TR_SKIP","NON-Z-COEFF", "TIME_ms","REF_IDX","MV_MOD_INT","MV_MOD_FRAC",\
                                "PREDMV_MOD_INT","PREDMV_MOD_FRAC","MVD_MOD_INT","MVD_MOD_FRAC","MVP_IDX","INTER_DIR","FME",\
                                "COLOC_SPLIT","UP_SPLIT","LEFT_SPLIT","UPLEFT_SPLIT","UPRIGHT_SPLIT","CTX_SPLIT", \
                                "COLOC_DEPTH","UP_DEPTH","LEFT_DEPTH","UPLEFT_DEPTH","UPRIGHT_DEPTH","CTX_DEPTH", \
                                "AVG_NEIGH_DEPTH","FINAL_PU","FINAL_TU", "FINAL_FME","SPLIT"};
...
public:
    ...
    static double cost_2Nx2N, cost_MSM, cost_2NxN, cost_Nx2N, ctx_ctu_depth, lambda;
